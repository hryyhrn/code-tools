...
@pytest.mark.parametrize(
    "input, expected", [
        ...
        ("+", [Token(1, 1, "+", TokenType.TK_VIS_CTRL)])
    ]
)
...
expected_results = [
    [
        ...
        Token(6, 28, "str", TokenType.TK_VAR_TYPE),
        Token(6, 31, ")", TokenType.TK_R_PARAN),
        Token(6, 32, ":", TokenType.TK_COLON),
        Token(6, 34, "int", TokenType.TK_VAR_TYPE),
        Token(7, 5, "#", TokenType.TK_VIS_CTRL),
        ...
        Token(7, 31, "char", TokenType.TK_VAR_TYPE),
        Token(7, 35, ")", TokenType.TK_R_PARAN),
        Token(7, 36, ":", TokenType.TK_COLON),
        Token(7, 38, "float", TokenType.TK_VAR_TYPE),
        Token(8, 5, "-", TokenType.TK_VIS_CTRL),
        ...
        Token(8, 57, "void", TokenType.TK_VAR_TYPE),
